...
import { Lock, Mail, Loader2, ArrowLeft, Building } from 'lucide-react';
...
export default function BranchLogin() {
  ...
  const targetBranch = branchCode ? mockBranches.find(b => b.username === branchCode) : null;
  ...
  useEffect(() => {
    if (targetBranch) {
      setEmail(targetBranch.username);
    }
  }, [targetBranch]);
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  onChange={(e) => !targetBranch && setEmail(e.target.value)}
                  className={`block w-full pl-10 bg-slate-950 border border-white/10 rounded-xl py-3 text-white placeholder-slate-500 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm transition-all ${targetBranch ? 'opacity-70 cursor-not-allowed' : ''}`}
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  className="block w-full pl-10 bg-slate-950 border border-white/10 rounded-xl py-3 text-white placeholder-slate-500 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm transition-all"
                  placeholder="••••••••"
                />
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 bg-slate-950 border-white/10 rounded text-emerald-500 focus:ring-emerald-500 focus:ring-offset-slate-900"
                />
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-slate-400">
                This portal is strictly for Branch Managers and Institution Administrators.
              </p>
            </div>
          </div>
        </div>
