...
function PopOutAlert({ message, type = 'info', onClose }: { id: number; message: string; type?: 'success' | 'error' | 'info'; onClose: () => void }) {
  const icons = {
  ...
  return (
    <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4 pointer-events-none">
      ...
      <div className="relative w-full max-w-sm bg-white/90 backdrop-blur-xl rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.15)] border border-white/50 p-8 flex flex-col items-center text-center overflow-hidden pointer-events-auto">
