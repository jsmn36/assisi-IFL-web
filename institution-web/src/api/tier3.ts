...
export const listGhostScores = (params?: any) =>
  client.get('/api/v1/ghost-booking', { params }).then(r => r.data);
export const getGhostScore = (id: number) =>
  client.get(`/api/v1/ghost-booking/${id}`).then(r => r.data);
...
export const evaluateBookingInline = (payload: any) =>
  client.post('/api/v1/ghost-booking/evaluate', payload).then(r => r.data);
...
export const getCloseCycle = (id: number) =>
  client.get(`/api/v1/accounting/close/cycles/${id}`).then(r => r.data);
export const getCloseCycleHealth = (id: number) =>
  client.get(`/api/v1/accounting/close/cycles/${id}/health`).then(r => r.data);
export const createCloseCycle = (data: any) =>
  client.post('/api/v1/accounting/close/cycles', data).then(r => r.data);
export const softCloseCycle = (id: number) =>
  client.post(`/api/v1/accounting/close/cycles/${id}/soft-close`).then(r => r.data);
export const hardCloseCycle = (id: number) =>
  client.post(`/api/v1/accounting/close/cycles/${id}/hard-close`).then(r => r.data);
...
export const updateCloseTask = (taskId: number, data: any) =>
  client.patch(`/api/v1/accounting/close/tasks/${taskId}`, data).then(r => r.data);
...
export const runCashForecast = (data: any) =>
  client.post('/api/v1/accounting/cash-forecast/run', data).then(r => r.data);
export const listForecastSnapshots = () =>
  client.get('/api/v1/accounting/cash-forecast/snapshots').then(r => r.data);
export const getForecastSnapshot = (id: number) =>
  client
    .get(`/api/v1/accounting/cash-forecast/snapshots/${id}`)
    .then(r => r.data);
export const arAging = () =>
  client.get('/api/v1/accounting/cash-forecast/aging').then(r => r.data);
...
export const listDecisionEntries = (params?: any) =>
  client.get('/api/v1/decision-audit', { params }).then(r => r.data);
export const getDecisionEntry = (id: number) =>
  client.get(`/api/v1/decision-audit/${id}`).then(r => r.data);
...
export const attachOutcome = (id: number, data: any) =>
  client.post(`/api/v1/decision-audit/${id}/outcome`, data).then(r => r.data);
...
export const listFilterTemplates = (params?: any) =>
  client.get('/api/v1/filter-templates', { params }).then(r => r.data);
...
export const getFilterTemplate = (id: number) =>
  client.get(`/api/v1/filter-templates/${id}`).then(r => r.data);
export const createFilterTemplate = (data: any) =>
  client.post('/api/v1/filter-templates', data).then(r => r.data);
export const updateFilterTemplate = (id: number, data: any) =>
  client.patch(`/api/v1/filter-templates/${id}`, data).then(r => r.data);
