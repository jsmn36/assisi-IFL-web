        ...
        <div className="p-6 h-full flex flex-col justify-between">
          <div className="space-y-8">
            <Link to="/" className="flex items-center gap-2 group">
              ...
              <span className="font-extrabold text-base tracking-tight bg-gradient-to-r from-white via-rose-100 to-rose-300 bg-clip-text text-transparent">
                ASSISI IFL Admin
              </span>
            </Link>
          ...
          <form onSubmit={handleRegisterInstitution} className="bg-slate-900 border border-slate-800 rounded-3xl p-6 md:p-8 space-y-6 animate-fadeIn">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-955 border border-slate-800 rounded-xl px-4 py-2.5 text-xs focus:outline-none focus:border-indigo-500"
                  />
                </div>

                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-slate-400">Branch Location / Region</label>
                  <input
                    type="text"
                    value={newLocation}
                    onChange={(e) => setNewLocation(e.target.value)}
                    placeholder="E.g. Kidangoor, Bharanaganam, Vagamon"
                    className="w-full bg-slate-955 border border-slate-800 rounded-xl px-4 py-2.5 text-xs focus:outline-none focus:border-indigo-500"
                  />
                </div>
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                className="w-full bg-slate-955 border border-slate-800 rounded-xl px-4 py-2.5 text-xs focus:outline-none focus:border-indigo-500 resize-none font-sans"
              />
            </div>
                ...
                <tbody className="divide-y divide-slate-850">
                  {institutions.map((inst) => (
                    <tr key={inst.id} className="hover:bg-slate-850/20 transition">
                      ...
                      <td className="py-4 px-6 text-xs font-bold text-emerald-400">
                        {inst.location || <span className="text-slate-600 font-normal">Main</span>}
                      </td>
